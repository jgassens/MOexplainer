...
export const guidedLessonContent: Record<GuidedRestLessonId, GuidedLessonData> = {
  bonding: {
    id: 'bonding',
    purpose: 'Turn the Lesson 1 phase rule and Lesson 2 addition rule into the chemical distinction between bonding and antibonding MOs.',
    question: 'How does the sign pattern of two overlapping orbitals decide whether electron density is built up or removed between nuclei?',
    visual: 'bonding',
    checkpointLead: 'Use the buttons to compare same-phase and opposite-phase overlap before answering.',
    endLead: 'Submit an explanation that links phase, node formation, and orbital energy. No answer key is exported.',
    stages: [
      {
        id: 'in-phase',
        shortTitle: 'Build density',
        title: 'Same signs reinforce between the nuclei',
        lead: 'When same-sign amplitudes overlap in the bonding region, the amplitudes add and electron density appears between the nuclei after squaring.',
        equation: 'same phase -> constructive overlap -> bonding MO',
        correction: 'Do not read the plus sign as positive charge. It is phase.',
      },
      {
        id: 'out-of-phase',
        shortTitle: 'Make a node',
        title: 'Opposite signs cancel and create a node',
        lead: 'When opposite signs meet in the internuclear region, the amplitudes cancel. The result is a node where electron density is removed from the bonding region.',
        equation: 'opposite phase -> destructive overlap -> antibonding MO',
        correction: 'Antibonding does not mean no interaction. It means a higher-energy interaction with a node in the wrong place.',
      },
      {
        id: 'energy-pair',
        shortTitle: 'Energy pair',
        title: 'Bonding and antibonding MOs come as an energy pair',
        lead: 'Mixing two starting orbitals gives two resulting MOs. One is stabilized by constructive overlap; the other is destabilized by destructive overlap.',
        equation: '2 starting orbitals -> 2 MOs',
        correction: 'Do not create only the bonding orbital. Conservation of orbitals requires the antibonding partner too.',
