  ...
  bonding: {
    ...
    stages: [
      ...
      },
      {
        ...
        lead: 'The picture is not showing electron density until after the signed addition has happened. First the starting orbital values add to make ψ for the molecular orbital. Then ψ is squared to make the density picture students usually recognize. Constructive addition gives density between the nuclei; destructive addition gives ψ = 0 at the bond center, which is a node.',
      ...
      },
      {
        ...
        lead: 'The slider below represents the strength of the orbital interaction in this teaching model. It is not changing the bond length and it is not making the orbital cloud physically expand. When the interaction is stronger, the bonding MO moves lower and the antibonding MO moves higher, so the energy split grows. With two electrons only the lower MO is occupied; with four electrons both are occupied, and the antibonding penalty is larger.',
